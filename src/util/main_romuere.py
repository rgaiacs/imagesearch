...
import util.parameter_estimation
import glob
from cnn import inception_feature_extraction

def run_evaluation():
    
    #flavio laptop
    #path_database = '/Users/flavio/Dropbox/Compartilhadas/Romuere/CBIR/cells/'
    #path_cnn_trained = '/Users/flavio/Dropbox/Compartilhadas/Romuere/CBIR/cells/features/model.ckpt'
    ...
    #cnn
    path_database = '/home/users/flavio/databases/cells/cells_test/'
    ...
    path_output = path_database + 'features/'
    #path_inception = '/home/users/flavio/databases/classify_image_graph_def.pb'
    ...
    MAP, fig = evaluation.evaluation(name_images_database, labels_database, name_images_database, labels_database,path_output,feature_extraction_method,distance,list_of_parameters,preprocessing_method,searching_method,percent_evaluate,path_cnn_trained=path_cnn_trained)
...
def run_get_time():
    ...
    #cnn
    #path_database = '/home/users/flavio/databases/cells/cells_test/'
    #path_retrieval = '/home/users/flavio/databases/cells/cells_test/query/'
    #path_cnn_trained = '/home/users/flavio/databases/cells/cells_train/features/model.ckpt'
    #path_cnn_trained = '/home/users/flavio/databases/inception_resnet_v2_2016_08_30.ckpt'
    #path_output = path_database + 'features/'
    
    distance = 'ed'
    searching_method_all = ['bf','kd','lsh']
    ...
    time_of_extraction_features, time_of_retrieval_images = evaluation.get_time_first_second_execution(name_images_database, labels_database, name_images_query, labels_query,path_cnn_trained,path_output,feature_extraction_method,distance,list_of_parameters,preprocessing_method,searching_method_all)
...
def run_retrieval_process_using_folders_structure():
    ...
    _, train_time, _ = run.run_command_line(name_images_database,labels_database,name_images_query,labels_query,path_cnn_trained,path_output,feature_extraction_method,distance,number_of_images,list_of_parameters,preprocessing_method,searching_method, False)
